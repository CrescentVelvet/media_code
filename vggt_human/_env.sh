...
# Dynamic mask (step 04, P0-1; GroundingDINO + SAM2/SAM text-prompted segmentation)
export ENABLE_DYNAMIC="${ENABLE_DYNAMIC:-1}"
...
export REPO_DIR VGGT_DIR VGGT_REPO GS_DIR GS_REPO MODEL_DIR RESULTS_DIR \
       ...
       ENABLE_DYNAMIC SAM2_MODEL_PATH DINO_MODEL_PATH \
