...
export RESULTS_DIR="${RESULTS_DIR:-$HOME/vggt_human_results}"
...
export RESULTS_DIR="$HOME/vggt_human_results"
...
echo "  3. GPU=0 INPUT_DIR=~/my_images RESULTS_DIR=~/vggt_human_results \\"
