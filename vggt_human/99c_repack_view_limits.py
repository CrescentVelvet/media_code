...
用法:
    FORCE=1 RADIUS_RANGE_SCALE=0.5 THETA_BUFFER=0 PHI_BUFFER=0 INIT_FOV_SCALE=1.25 PHI_MARGIN=40 THETA_MARGIN=40 python vggt_human/99c_repack_view_limits.py
    python ... # 默认只收 Phi 两侧 10°
