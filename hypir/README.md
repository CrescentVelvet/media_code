...
# 03e) 抽样核对(compare_decolor/ 下 [orig|beauty|decolor] 三联图，确认去红润+磨皮保留)
GPU=0 BEAUTY_DIR=../HYPIR/dataset/beauty_guojia_datas_20260708 SAVE_COMPARE=1 SKIP_PARQUET=1 bash hypir/03e_decolor_beauty_dataset.sh
# 03e) 全量产图+建 parquet(前提: 03d 已产出 hq_orig/+hq_beauty/+lq_gauss/)
GPU=0 BEAUTY_DIR=../HYPIR/dataset/beauty_guojia_datas_20260708 bash hypir/03e_decolor_beauty_dataset.sh
