...
echo "  lora:      $WEIGHT_PATH  (rank=$LORA_RANK)"
echo "  lq:        $LQ_DIR"
echo "  prompts:   ${TXT_DIR:-<none -> empty caption>}"
echo "  output:    $OUTPUT_DIR  (result/ + prompt/)"
echo "  restore:   scale_by=$SCALE_BY upscale=$UPSCALE patch=$PATCH_SIZE stride=$STRIDE seed=$SEED"
