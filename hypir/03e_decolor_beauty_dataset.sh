...
echo " 💎     PARQUET_PATH=$PARQUET_OUT OUTPUT_DIR=../HYPIR/experiments/beauty_decolor bash $SCRIPT_DIR/04b_train_paired.sh"
echo " 💎   训完用 02 推理(WEIGHT_PATH 指向新 checkpoint)，即出'去红润 + 磨皮'效果："
echo " 💎     GPU=0 LQ_DIR=../HYPIR/input/test_faces WEIGHT_PATH=../HYPIR/experiments/beauty_decolor/checkpoint-N/ema_state_dict.pth bash $SCRIPT_DIR/02_run_inference.sh"
